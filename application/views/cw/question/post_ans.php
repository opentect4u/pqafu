<div class="main-panel">
            ...
            <form class="form-horizontal" action="<?=base_url()?>admin/cw/post_ans" method = "POST">
                    <input type="hidden" value="<?php if(isset($que->id)){ echo $que->id;} ?>" name='id'>
           ...
           <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                 ...
                 <div class="col-sm-12" style="margin-bottom: 15px;">
                    ...
                    <div class="fieldSec">
                    <textarea name="answer" class="form-control" rows="6" id="editor" ><?php if(isset($que->answer)){ echo $que->answer;} ?></textarea>
                     </div>
