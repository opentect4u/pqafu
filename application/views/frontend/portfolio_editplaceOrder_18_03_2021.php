...
<div class="col-sm-9 float-left">
   ...
   <image src="<?=base_url()?>uploads/order/<?php if(isset($orders->order_image)){ echo $orders->order_image ;}?>">
  	</div>
	</div>	
	<div class="col-sm-6 float-left">
	<div class="form-group">
    <label>Dead Line</label>
    <input type="date" class="form-control" name="order_dead_line" id="order_dead_line" value="<?php if(isset($orders->order_dead_line)){ echo date('Y-m-d',strtotime($orders->order_dead_line));}?>" readonly>
  	</div>	
	</div>	
