...
<div class="col-sm-12 loginBody">
	...
	<div class="col-sm-12">
		<h1>Sign Up</h1>
         ...
         <form action="<?=base_url()?>auth/signup" method="POST" id="form">
		...
		<div class="form-group">
	     ...
	     <input type="email" class="form-control" placeholder="Email" name="email" required></label>
			...
			<div class="form-group">
	     <label class="inputWraper"><!-- <i class="fa fa-lock" aria-hidden="true" id="togglePassword"></i> -->
	    <i class="fa fa-lock" aria-hidden="true" id="togglePassword"></i>
	      <input type="password" class="form-control" placeholder="Password" name="password" id="pswd1" required>
        <span style = "color:red">Password Contain uppercase letters, numerals, and at least one special characters !</span>

	  </label>

	     </div>
			<div class="form-group">
	     <label class="inputWraper"><i class="fa fa-lock" aria-hidden="true" id="togglePassword1"></i>
    ...
    <input type="text" class="form-control" placeholder="captcha" name="captcha" ></label>
		...
		<div class="form-group">
		<input type="submit" class="btn btnRed widthFull"  value="Sign up now">
		</div>
    </form>
...
<script>  
        ...
        var pw2 = document.getElementById("pswd2").value;  
                       ...
                       if(pw1 != pw2){
                            	...
                            	if (!pw1.match(/[A-Z]/)) {
                            		 ...
                            		 alert("Passwords did not Contain Uppercase!");
						                return false;
						            }else if(!pw1.match(/[0-9]/)){

						              alert("Passwords did not Contain Numeric Value!");
						              return false;
						            }else if(!pw1.match(/([!,%,&,@,#,$,^,*,?,_,~])/)){

						              alert("Passwords did not Contain Special Character!");
						              return false;
						            }
    ...
    const password = document.querySelector('#pswd1');
    const password1 = document.querySelector('#pswd2');
