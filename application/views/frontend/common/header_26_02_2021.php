...
<div class="rightNavSec">
  <ul>
	...
	<form class="info form_inlineCustome" autocomplete="off" action="<?=base_url()?>search" id="myform" method="POST">
		...
		<input type="text" class="search_trade form-control mr-sm-2" placeholder="Search Questions" aria-label="Search" id="search_trade" name="search">
   ...
   <!-- <div id="display" ></div> -->
    <?php if(!$this->session->userdata('user_id')){ ?>
	 ...
	 <a href="<?=base_url()?>login"><button class="btn orgBtn" type="submit">Sign In</button></a>
...
<!--		<img src="images/c1.jpg" alt="...">-->
		...
		<a onclick="myFunction()" class="dropbtn loginThumb" >&nbsp;</a>
