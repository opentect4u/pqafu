...
<div class="listBoxBody">
		...
		<div class="listRightDetails">
			  <p><span class="listTitle">James Smith</span>  Asked: <span><?php echo date("F j, Y",strtotime($question->ask_dt)) ;?><!-- April 19, 2018 --></span>    Category: <span><?php if(isset($question->cat_name)){ echo $question->cat_name;}?></span>      Grade: <span><?php if(isset($question->grade_name)){ echo $question->grade_name;}?></span></p>
	...
	<br clear="all">
	 ...
	 <div class="listBoxFooter">
		...
		<a href="#" class="btnAns"> <i class="fa fa-comments" aria-hidden="true"></i><?php echo get_answer_no($question->id);?>  Answer</a>
		<div class="right-btn">
		<!--    <a href="#" class="btnAns"> <i class="fa fa-thumbs-up" aria-hidden="true"></i> 8 Likes</a> -->
		     <button class="like btnAns" value="<?=$question->id?>"> <i class="fa fa-thumbs-up" aria-hidden="true" ></i> <?php echo get_like_no($question->id);?>  Likes</button>
