    ...
    public function index(){
            ...
            $apiContext = new \PayPal\Rest\ApiContext(
                    new \PayPal\Auth\OAuthTokenCredential(
                        'ASSMjkIti2eRCPrmpXrh8OknYbf5v0chpzZ96Dg6y7TGd3G5sJx4jDDYZ6Uc0wK14yZPh86a2sq-SnFz',     // ClientID
     ...
     public function second(){
        ...
        $product_id   = $this->input->get('prod_id');
         ...
         $apiContext = new \PayPal\Rest\ApiContext(
                    new \PayPal\Auth\OAuthTokenCredential(
                        'ASSMjkIti2eRCPrmpXrh8OknYbf5v0chpzZ96Dg6y7TGd3G5sJx4jDDYZ6Uc0wK14yZPh86a2sq-SnFz',     // ClientID
                        'EH8MzZSib01yUaeudCjmZAFVcvBajpqiZG7DyiazO2iVVLni8FqB9suYUTcHqzojiMWD48fMUgDRtcGe'      // ClientSecret
                    )
            );
        ...
        $redirect_urls->setReturnUrl(base_url()."paypal/success") /** Specify return URL **/
            ->setCancelUrl(base_url()."paypal/success");
