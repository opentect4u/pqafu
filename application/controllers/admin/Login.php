         	...
         	if($this->input->post("uemail"))
				{
                    ...
                    $verify   = $this->Master->f_get_particulars('md_users',NULL,array("email"    => $email),1);
							...
							if($match)
							...
							else
								{
									...
									redirect(base_url()."admin/");
					 	            ...
					 	            $this->session->set_flashdata('login_error', 'Verification process pending');
					 				redirect(base_url()."admin/");
								}	
					    }else{
